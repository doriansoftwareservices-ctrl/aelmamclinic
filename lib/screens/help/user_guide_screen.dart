      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            const _Section(
              title: '11) استخراج البيانات محليا',
              bullets: [
                'اضغط على خيار "استخراج البيانات محليا" لإنشاء ملف HTML شامل.',
                'سيتم حفظ الملف في مجلد Downloads ويمكنك تصدير Excel/CSV من داخله.',
              ],
            ),
            const _Section(
