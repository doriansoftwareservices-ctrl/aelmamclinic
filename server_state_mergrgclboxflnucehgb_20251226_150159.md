...
- Generated: `2025-12-26T15:02:00+03:00`
...
## Hasura metadata inconsistencies

```
```


## Hasura export_metadata summary

```
```


## DB schema (public/auth/storage tables & views)

```
```


## Key RPCs (existence + return types)

```
```


## GraphQL sanity (key mutations present?)
