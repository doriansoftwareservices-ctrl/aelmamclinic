-- Tighten v_chat_conversations_for_me to only return conversations the user participates in
-- (or created_by), removing any superadmin bypass to prevent leakage.
DO $m$
DECLARE
