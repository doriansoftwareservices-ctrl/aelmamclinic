...
DROP FUNCTION IF EXISTS public.set_current_account(json, uuid);
DROP TABLE IF EXISTS public.user_current_account;

-- Restore my_account_id() to latest membership behavior.
...
-- Restore my_profile() to the previous fallback-only behavior.
