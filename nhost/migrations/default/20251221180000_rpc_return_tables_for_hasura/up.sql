...
BEGIN
  IF p_account_id IS NULL THEN
    RETURN QUERY SELECT false, 'account_id is required', NULL::uuid, NULL::boolean;
    RETURN;
  END IF;
  ...
  IF updated_id IS NULL THEN
    RETURN QUERY SELECT false, 'account not found', NULL::uuid, NULL::boolean;
    RETURN;
  END IF;

  RETURN QUERY SELECT true, NULL::text, updated_id, coalesce(p_frozen, false);
END;
$$;
...
BEGIN
  IF p_account_id IS NULL THEN
    RETURN QUERY SELECT false, 'account_id is required', NULL::uuid;
    RETURN;
  END IF;
  ...
  IF deleted_id IS NULL THEN
    RETURN QUERY SELECT false, 'account not found', NULL::uuid;
    RETURN;
  END IF;

  RETURN QUERY SELECT true, NULL::text, deleted_id;
END;
$$;
...
BEGIN
  IF normalized_clinic = '' OR normalized_email = '' THEN
    RETURN QUERY SELECT false, 'clinic_name and owner_email are required', NULL::uuid, NULL::uuid, NULL::uuid, NULL::text;
    RETURN;
  END IF;
  ...
  RETURN QUERY SELECT true, NULL::text, acc_id, owner_uid, owner_uid, normalized_role;
END;
$$;
...
BEGIN
  ...
  IF p_account IS NULL THEN
    RETURN QUERY SELECT false, 'account_id is required', NULL::uuid, NULL::uuid, NULL::text;
    RETURN;
  END IF;

  IF normalized_email = '' THEN
    RETURN QUERY SELECT false, 'email is required', NULL::uuid, NULL::uuid, NULL::text;
    RETURN;
  END IF;
  ...
  IF NOT COALESCE(account_exists, false) THEN
    RETURN QUERY SELECT false, 'account not found', NULL::uuid, NULL::uuid, NULL::text;
    RETURN;
  END IF;
  ...
  RETURN QUERY SELECT true, NULL::text, p_account, emp_uid, normalized_role;
END;
$$;
...
BEGIN
  ...
  RETURN QUERY SELECT true, NULL::text, p_account, p_user_uid, coalesce(p_disabled, false);
END;
$$;
...
BEGIN
  ...
  RETURN QUERY SELECT true, NULL::text, p_account, p_user_uid;
END;
$$;
...
BEGIN
  ...
  IF v_inv.status <> 'pending' THEN
    RETURN QUERY SELECT false, 'invitation not pending';
    RETURN;
  END IF;
