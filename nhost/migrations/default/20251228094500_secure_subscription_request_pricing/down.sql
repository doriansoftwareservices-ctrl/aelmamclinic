-- Restore create_subscription_request signature with client-provided amount
...
REVOKE ALL ON FUNCTION public.create_subscription_request(text, uuid, numeric, text, text, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.create_subscription_request(text, uuid, numeric, text, text, text) TO public;
