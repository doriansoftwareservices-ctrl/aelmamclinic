...
DROP VIEW IF EXISTS public.v_payment_stats_by_plan;
DROP VIEW IF EXISTS public.v_payment_stats_by_day;
DROP VIEW IF EXISTS public.v_payment_stats_by_month;
