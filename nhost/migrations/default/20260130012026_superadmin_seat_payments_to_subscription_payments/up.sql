...
-- Ensure approved seat payments are recorded in subscription_payments for stats.
...
BEGIN
  ...
  IF p_approve IS TRUE THEN
    ...
    -- Record payment for stats (seat requests are separate from subscription_requests).
