...
DROP FUNCTION IF EXISTS public.admin_set_employee_seat_price(text, numeric);
DROP FUNCTION IF EXISTS public.admin_get_employee_seat_pricing();
DROP FUNCTION IF EXISTS public.employee_seat_price(text);
DROP VIEW IF EXISTS public.v_employee_seat_pricing;
DROP TABLE IF EXISTS public.employee_seat_pricing;

-- Restore previous owner_request_extra_employee behavior (fixed price 50).
