...
|-------|----------------|-----------------|-----------------|
| Super Admin | 1) تسجيل الدخول بحساب سوبر أدمن مُسجّل في `public.super_admins`. 2) التحقق من `my_feature_permissions`. 3) فتح شاشات المخزون والإحصائيات. 4) إرسال رسالة ومرفق. 5) إنشاء مجموعة ودعوة مالك. 6) قبول/رفض الدعوات. | غير منفذ (البيئة غير متصلة) | نفّذ الأوامر من التطبيق بعد تشغيل Supabase، وسجّل السجل في مسار CI. |
